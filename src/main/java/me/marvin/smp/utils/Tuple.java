...
public interface Tuple<A, B> {
    ...
    /**
     * Creates a new mutable tuple out of this tuple.
     *
     * @return a new mutable tuple
     */
    default Tuple.Mutable<A, B> mutable() {
        return mutableTuple(first(), second());
    }
    ...
    interface Mutable<A, B> extends Tuple<A, B> {
         ...
         * @return this tuple
         */
        Tuple.Mutable<A, B> first(@Nullable A first);
         ...
         * @return this tuple
         */
        Tuple.Mutable<A, B> second(@Nullable B second);

        /**
         * Creates a new immutable tuple out of this tuple.
         *
         * @return a new immutable tuple
         */
        default Tuple<A, B> immutable() {
